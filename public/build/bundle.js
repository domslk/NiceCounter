...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	function counter_count_binding(value) {
    		/*counter_count_binding*/ ctx[2](value);
    	}

    	let counter_props = {};

    	if (/*count*/ ctx[0] !== void 0) {
    		counter_props.count = /*count*/ ctx[0];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_count && dirty & /*count*/ 1) {
    				updating_count = true;
    				counter_changes.count = /*count*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Counter, count, something });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*count*/ 1) {
    			$$invalidate(1, something = count == 0 ? "Counter" : count);
    		}
    	};

    	return [count, something, counter_count_binding];
    }
